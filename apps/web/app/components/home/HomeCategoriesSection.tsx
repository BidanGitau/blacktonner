...
export function HomeCategoriesSection() {
  return (
    <section className="container mx-auto px-4 pb-10 pt-16 lg:px-6">
        ...
        {CATEGORIES.map((category, index) => {
          ...
          return (
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
              style={{
