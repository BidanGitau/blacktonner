...
export function HomeTrustSection() {
  return (
    <section className="container mx-auto px-4 py-10 sm:py-12 lg:px-6">
      <div className="grid grid-cols-1 gap-3 min-[420px]:grid-cols-2 sm:gap-4 md:grid-cols-4">
        {TRUST.map((item, index) => {
          ...
          return (
            <div
              key={item.title}
              className="flex min-w-0 items-center gap-3 rounded-xl border border-slate-100 bg-white px-4 py-4 shadow-sm sm:rounded-2xl"
              style={{
